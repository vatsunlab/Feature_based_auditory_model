function dir_struct = bookkeep_dirstruct(dir_struct, Root_out_dir, out_dir_arg_type)
...
if strcmp(out_dir_arg_type, 'default')
    ...
    if count>0
        ...
        temp_FBAM_dir= strrep(sprintf('%s_run%d', dir_struct.FBAM_dir, count), Root_out_dir, '');
...
dir_struct.mel_spectrogram_dir= fullfile(dir_struct.mel_spectrogram_dir, filesep);
dir_struct.FBAM_dir= fullfile(dir_struct.FBAM_dir, filesep);
